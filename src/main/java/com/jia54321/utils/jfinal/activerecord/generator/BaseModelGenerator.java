...
public class BaseModelGenerator {
	...
	public void generate(List<TableMetaExtend> tableMetas) {
		...
		for (TableMetaExtend tableMeta : tableMetas) {
			genBaseModelContent(tableMeta);
		}
		writeToFile(tableMetas);
	}

	protected void genBaseModelContent(TableMetaExtend tableMeta) {
	...
	protected void writeToFile(List<TableMetaExtend> tableMetas) {
		try {
			for (TableMetaExtend tableMeta : tableMetas) {
	 ...
	 * base model 覆盖写入
	 */
	protected void writeToFile(TableMetaExtend tableMeta) throws IOException {
