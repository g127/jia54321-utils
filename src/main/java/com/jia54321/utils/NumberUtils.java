...
public class NumberUtils {
    ...
    public static int toInt(final String str, 
    		final String cond1, final int v1, 
    ...
    public static int toInt(final String str, 
    		final String cond1, final int v1, 
    		final String cond2, final int v2, 
    		final int defaultValue) {
        if(cond2.equals(str)) {
        	return v2;
        }else{
        	return toInt(str, cond1, v1, defaultValue);
        }
    }
    ...
    public static int toInt(final String str, 
    		final String cond1, final int v1, 
    		final String cond2, final int v2, 
    		final String cond3, final int v3, 
    		final int defaultValue) {
        if(cond3.equals(str)) {
        	return v3;
        }else{
        	return toInt(str, cond1, v1, cond2, v2, defaultValue);
        }
    }
